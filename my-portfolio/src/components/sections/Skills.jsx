        ...
        <div className="max-w-4xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-8">
                {skills.map((skillCategory, index) => (
                    <SpotlightCard key={index} className="bg-zinc-900 rounded-2xl p-6 hover:bg-zinc-800 transition-all duration-300 transform hover:scale-105 border border-zinc-800" spotlightColor="rgba(196, 154, 26, 0.25)">
